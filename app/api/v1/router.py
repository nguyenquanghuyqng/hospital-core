...
theo nhóm chức năng: auth → queue → patients → reception → doctor → examination → catalog → admin.
"""
from fastapi import APIRouter

from app.api.v1.endpoints import queue, patients, reception, auth, doctor, examination, catalog, admin
